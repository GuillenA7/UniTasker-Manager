...
public class frmAddPrestamo extends javax.swing.JFrame
{

    private frmMenu menu;
    Prestamo prestamoP = new Prestamo();
    
    public frmAddPrestamo(frmMenu menu, Prestamo prestamoP)
    {
        initComponents();
        this.menu = menu;
    ...
    public static void main(String args[])
    {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAddPrestamo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
