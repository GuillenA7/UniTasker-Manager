...
public class frmShowPrestamo extends javax.swing.JFrame
{

    private frmMenu menu;
    Prestamo prestamoP = new Prestamo();
    
    public frmShowPrestamo(frmMenu menu, Prestamo prestamoP)
    {
        initComponents();
        this.menu = menu;
    ...
    public static void main(String args[])
    {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmShowPrestamo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                // new frmShowPrestamo().setVisible(true);
            }
        });
    }
