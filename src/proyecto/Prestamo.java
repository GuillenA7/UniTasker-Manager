...
public class Prestamo
{
    ...
    private float fees;
    private Prestamo next;

    public Prestamo(int reg, int egressDay, String egressMonth, int entryDay, String entryMonth, float fees)
    {
        this.reg = reg;
    ...
    public Prestamo getNext()
    {
        return next;
    }

    public void setNext(Prestamo next)
    {
        this.next = next;
    }  
    ...
    {
        Prestamo node = new Prestamo(reg, egressDay, egressMonth, entryDay, entryMonth, fees);
