...
public class frmAddLibro extends javax.swing.JFrame
{

    private frmMenu menu;
    Libro libroP = new Libro();
    
    public frmAddLibro(frmMenu menu, Libro libroP)
    {
        initComponents();
        this.menu = menu;
        this.libroP = libroP;
    ...
    public static void main(String args[])
    {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAddLibro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                // new frmAddLibro().setVisible(true);
            }
        });
    }
